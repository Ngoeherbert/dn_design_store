...
import {
  ...
  ChevronLeft, ChevronRight, Star, Minus, Plus, Share2
} from "lucide-react";
...
export function ProductDetailClient({ product, settings }: Props) {
        ...
        <div>
          <div className="relative overflow-hidden rounded-3xl bg-gray-50 aspect-square mb-4">
            <AnimatePresence mode="wait">
              <motion.img
                key={imageIndex}
                src={images[imageIndex] ?? "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=600&q=80"}
                alt={product.name}
