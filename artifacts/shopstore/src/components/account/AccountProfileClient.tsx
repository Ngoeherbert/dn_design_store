        ...
        <form onSubmit={handleSave} className="space-y-5">
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
            ...
            <button
              ...
              className={`relative w-12 h-6 rounded-full transition-colors ${newsletter ? "bg-gray-900" : "bg-gray-200"}`}
            >
              <span className={`absolute top-1 w-4 h-4 rounded-full bg-white shadow transition-transform ${newsletter ? "translate-x-7" : "translate-x-1"}`} />
            </button>
          </div>
