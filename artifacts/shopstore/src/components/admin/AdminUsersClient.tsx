...
const DEMO_USERS = [
  { id: "1", name: "Jane Doe", email: "jane@example.com", role: "admin", createdAt: new Date("2025-01-15"), emailVerified: true },
  { id: "2", name: "John Smith", email: "john@example.com", role: "user", createdAt: new Date("2025-02-20"), emailVerified: true },
  { id: "3", name: "Alice Johnson", email: "alice@example.com", role: "user", createdAt: new Date("2025-03-05"), emailVerified: false },
];

export function AdminUsersClient({ users: serverUsers }: { users: any[] }) {
  const displayUsers = serverUsers.length > 0 ? serverUsers : DEMO_USERS;
